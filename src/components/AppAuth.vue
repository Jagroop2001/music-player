            ...
            <div
                ...
                <div class="py-4 text-left px-6">
                    ...
                    <div class="flex justify-between items-center pb-4">
                        ...
                        <!-- Modal Close Button -->
                        <div class="modal-close cursor-pointer imgStyle z-50" @click="modalVisibility = false">
                    ...
                    <!-- Registration Form -->
                    <app-register-from v-else></app-register-from>
...
import AppRegisterFrom from './RegisterFrom.vue';
export default {
    name: "AppAuth",
    components: {
        AppLoginForm,
